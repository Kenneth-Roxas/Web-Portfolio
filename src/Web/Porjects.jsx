                ...
                {!cert ? (
                    <div className="relative max-w-screen mx-auto">
                        <button
                            ...
                            className="absolute left-0 sm:-left-5 top-1/2 -translate-y-1/2 -translate-x-1/2 z-20 w-10 h-10 rounded-full bg-slate-800/90 border border-slate-600 text-slate-300 flex items-center justify-center hover:bg-sky-500 hover:text-white hover:border-sky-500 transition-colors"
                        >
                        ...
                        <button
                            ...
                            className="absolute right-0 sm:-right-5 top-1/2 -translate-y-1/2 translate-x-1/2 z-20 w-10 h-10 rounded-full bg-slate-800/90 border border-slate-600 text-slate-300 flex items-center justify-center hover:bg-sky-500 hover:text-white hover:border-sky-500 transition-colors"
                        >
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <Swiper
                            ...
                            loop={true}
                            className="max-w-full [--swiper-pagination-color:#38bdf8]"
                        >
                            {project.map((proj) => (
